...
class Guitar : public Stk
{
 public:
  ...
  unsigned int channelsOut( void ) const { return lastFrame_.channels(); }; // added by mk
  ...
  */
  ...
  StkFloat lastOut( unsigned int channel = 0 ); //added by mk
...
inline StkFloat Guitar :: lastOut( unsigned int channel )
{

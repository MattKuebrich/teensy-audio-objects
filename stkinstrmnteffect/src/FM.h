...
class FM : public Instrmnt
{
 ...
 protected:
  ...
  //added by mk
  std::vector<StkFloat> baseGains; // 1.4.1.0 (prc): REPAIRATHON2021 addition
  StkFloat op4Feedback; // 1.4.1.0 (prc): REPAIRATHON2021 addition
  std::vector<StkFloat> opAMs; // 1.4.1.0 (prc): REPAIRATHON2021 addition

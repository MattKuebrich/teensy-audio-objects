#ifndef STK_FRENCHRN_H
#define STK_FRENCHRN_H
...
inline StkFloat FrencHrn :: tick( unsigned int )
{
...
inline StkFrames& FrencHrn :: tick( StkFrames& frames, unsigned int channel )
{
  unsigned int nChannels = lastFrame_.channels();
#if defined(_STK_DEBUG_)
  if ( channel > frames.channels() - nChannels ) {
    oStream_ << "FrencHrn::tick(): channel and StkFrames arguments are incompatible!";

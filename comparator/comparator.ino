...
AudioSynthWaveformModulated oscA;      //xy=484.00001525878906,1270.0000491142273
AudioSynthWaveformModulated oscB;      //xy=484.0000305175781,1320.0000305175781
...
AudioConnection          patchCord1(oscA, 0, comparator1, 0);
AudioConnection          patchCord2(oscB, 0, comparator1, 1);
...
void loop() {
  ...
  oscA.frequency(oscAfreq);
  oscB.frequency(oscBfreq);
}
